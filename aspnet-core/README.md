...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 27830bff-fa50-4c37-bcec-56a568ddd1f9
```

> `27830bff-fa50-4c37-bcec-56a568ddd1f9` is the password of the certificate, you can change it to any password you want.
